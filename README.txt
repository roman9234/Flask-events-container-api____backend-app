...
Касательно совета по изучению Flask, я рекомендую тебе следующее:

1. Изучай структуру приложения Flask и основные компоненты, такие как роуты, шаблоны и контроллеры.
2. Практикуйся создавая простые приложения и постепенно усложняя их, чтобы лучше понимать работу фреймворка.
3. Изучай документацию Flask и прочитывай примеры кода, чтобы понимать, как можно решать различные задачи с использованием фреймворка.
4. Хороший практикой являться Docstrings в коде :
https://pythonist.ru/docstrings-dokumentirovanie-koda-v-python/

Можно например попробывать к этому проекту подключить базу данных например SQlite
